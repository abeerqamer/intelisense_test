package com.production.abeer.intelisense_test;
...
public class MainActivity extends ListActivity {
    ...
    private static final String url = "https://raw.githubusercontent.com/mobilesiri/JSON-Parsing-in-Android/master/index.html";
    ...
    private class GetStudents extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            JSON_parser webreq = new JSON_parser();

            // Making a request to url and getting response
            String jsonStr = webreq.makeWebServiceCall(url, JSON_parser.GET);
